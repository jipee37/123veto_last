<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
	<ul class="nav nav-pills">
		<li class="feed"><a href="<?php bp_group_activity_feed_link(); ?>" title="<?php esc_attr_e( 'RSS Feed', 'firmasite' ); ?>"><?php _e( 'RSS', 'firmasite' ); ?></a></li>
...
<div class="activity single-group margin-top">
