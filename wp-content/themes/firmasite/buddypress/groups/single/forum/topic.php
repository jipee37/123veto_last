...
<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
	...
	<?php if ( bp_has_forum_topic_posts() ) : ?>
		...
		<ul id="topic-post-list" class="item-list list-unstyled margin-top">
				...
				<li id="post-<?php bp_the_topic_post_id(); ?>" class="<?php bp_the_topic_post_css_class(); ?>">
				  <div class="panel panel-default"><div class="panel-body">
					...
					<div class="admin-links">
						...
						<a href="#post-<?php bp_the_topic_post_id(); ?>" title="<?php esc_attr_e( 'Permanent link to this post', 'firmasite' ); ?>">#</a>
					</div>
                  </div></div>
				</li>
		...
		<?php if ( bp_get_the_topic_is_last_page() ) : ?>
			...
			<?php if ( bp_get_the_topic_is_topic_open() && !bp_group_is_user_banned() ) : ?>
				...
				<div id="post-topic-reply">
					...
					<div class="submit">
						<input type="submit" class="btn btn-primary" name="submit_reply" id="submit" value="<?php esc_attr_e( 'Post Reply', 'firmasite' ); ?>" />
					</div>
