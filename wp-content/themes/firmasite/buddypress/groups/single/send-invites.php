...
if ( bp_get_new_group_invite_friend_list() ) : ?>
	...
	<form action="<?php bp_group_send_invite_form_action(); ?>" method="post" id="send-invite-form" class="standard-form margin-top">
		...
		<div class="submit">
			<input type="submit" class="btn btn-primary" name="submit" id="submit" value="<?php esc_attr_e( 'Send Invites', 'firmasite' ); ?>" />
		</div>
