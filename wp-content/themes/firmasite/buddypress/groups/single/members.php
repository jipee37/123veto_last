<?php if ( bp_group_has_members( bp_ajax_querystring( 'group_members' ) ) ) : ?>
	...
	<ul id="member-list" class="item-list list-unstyled margin-top">
		...
		<?php while ( bp_group_members() ) : bp_group_the_member(); ?>
			...
			<li>
             <div class="panel panel-default"><div class="panel-body">
				...
				<span class="label label-default activity"><?php bp_group_member_joined_since(); ?></span>
...
<?php else: ?>
	...
	<div class="clearfix"></div><div id="message" class="info alert alert-info">
		<p><?php _e( 'No members were found.', 'firmasite' ); ?></p>
	</div>
