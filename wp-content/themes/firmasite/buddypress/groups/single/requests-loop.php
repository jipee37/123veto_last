			...
			<li>
             <div class="panel panel-default"><div class="panel-body">
				...
				<div class="action">
					...
					<?php bp_button( array( 'id' => 'group_membership_accept', 'component' => 'groups', 'wrapper_class' => 'accept', 'link_href' => bp_get_group_request_accept_link(), 'link_class' => 'btn btn-default', 'link_title' => __( 'Accept', 'firmasite' ), 'link_text' => __( 'Accept', 'firmasite' ) ) ); ?>

					<?php bp_button( array( 'id' => 'group_membership_reject', 'component' => 'groups', 'wrapper_class' => 'reject', 'link_href' => bp_get_group_request_reject_link(), 'link_class' => 'btn btn-default', 'link_title' => __( 'Reject', 'firmasite' ), 'link_text' => __( 'Reject', 'firmasite' ) ) ); ?>
