...
<div id="buddypress">
	...
	<div class="item-list-tabs activity-type-tabs pull-left" role="navigation">
		<ul class="nav nav-pills">
			...
			<li class="selected" id="activity-all"><a href="<?php bp_activity_directory_permalink(); ?>" title="<?php esc_attr_e( 'The public activity for everyone on this site.', 'firmasite' ); ?>"><?php printf( __( 'All Members <span>%s</span>', 'firmasite' ), bp_get_total_member_count() ); ?></a></li>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_is_active( 'friends' ) ) : ?>
					...
					<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
						...
						<li id="activity-friends"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/'; ?>" title="<?php esc_attr_e( 'The activity of my friends only.', 'firmasite' ); ?>"><?php printf( __( 'My Friends <span>%s</span>', 'firmasite' ), bp_get_total_friend_count( bp_loggedin_user_id() ) ); ?></a></li>
				...
				<?php if ( bp_is_active( 'groups' ) ) : ?>
					...
					<?php if ( bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
						...
						<li id="activity-groups"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_groups_slug() . '/'; ?>" title="<?php esc_attr_e( 'The activity of groups I am a member of.', 'firmasite' ); ?>"><?php printf( __( 'My Groups <span>%s</span>', 'firmasite' ), bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ); ?></a></li>
				...
				<?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) : ?>
					...
					<li id="activity-favorites"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/'; ?>" title="<?php esc_attr_e( "The activity I've marked as a favorite.", 'firmasite' ); ?>"><?php printf( __( 'My Favorites <span>%s</span>', 'firmasite' ), bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ); ?></a></li>
				...
				<?php if ( bp_activity_do_mentions() ) : ?>
					...
					<li id="activity-mentions"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/mentions/'; ?>" title="<?php esc_attr_e( 'Activity that I have been mentioned in.', 'firmasite' ); ?>"><?php _e( 'Mentions', 'firmasite' ); ?><?php if ( bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ) : ?> <strong><span><?php printf( _nx( '%s new', '%s new', bp_get_total_mention_count_for_user( bp_loggedin_user_id() ), 'Number of new activity mentions', 'firmasite' ), bp_get_total_mention_count_for_user( bp_loggedin_user_id() ) ); ?></span></strong><?php endif; ?></a></li>
	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul class="nav nav-pills">
			...
			<?php
			/*<li class="feed"><a href="<?php bp_sitewide_activity_feed_link(); ?>" title="<?php esc_attr_e( 'RSS Feed', 'firmasite' ); ?>"><?php _e( 'RSS', 'firmasite' ); ?></a></li>*/
