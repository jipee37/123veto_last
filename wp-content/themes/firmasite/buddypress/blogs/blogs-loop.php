...
<?php if ( bp_has_blogs( bp_ajax_querystring( 'blogs' ) ) ) : /*?>
	...
	<ul id="blogs-list" class="item-list list-unstyled">
	...
	<?php while ( bp_blogs() ) : bp_the_blog(); ?>
		...
		<li <?php bp_blog_class() ?>>
			...
			<div class="item">
				<div class="item-title"><a class="lead" href="<?php bp_blog_permalink(); ?>"><?php bp_blog_name(); ?></a></div>
				<div class="item-meta"><span class="label label-default activity"><?php bp_blog_last_active(); ?></span></div>
