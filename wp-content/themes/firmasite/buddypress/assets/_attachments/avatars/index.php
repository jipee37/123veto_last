...
<script id="tmpl-bp-avatar-delete" type="text/html">
	<# if ( 'user' === data.object ) { #>
		...
		<p><a class="btn btn-default btn-xs button edit" id="bp-delete-avatar" href="#" title="<?php esc_attr_e( 'Delete Profile Photo', 'firmasite' ); ?>"><?php esc_html_e( 'Delete My Profile Photo', 'firmasite' ); ?></a></p>
	<# } else if ( 'group' === data.object ) { #>
		...
		<p><a class="btn btn-default btn-xs button edit" id="bp-delete-avatar" href="#" title="<?php esc_attr_e( 'Delete Group Profile Photo', 'firmasite' ); ?>"><?php esc_html_e( 'Delete Group Profile Photo', 'firmasite' ); ?></a></p>
	<# } else { #>
