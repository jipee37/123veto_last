...
<script id="tmpl-bp-avatar-webcam" type="text/html">
	<# if ( ! data.user_media ) { #>
		<div id="bp-webcam-message">
			<p class="warning"><?php esc_html_e( 'Your browser does not support this feature.', 'firmasite' );?></p>
		</div>
	<# } else { #>
		...
		<div class="avatar-crop-management">
			...
			<div id="avatar-crop-actions">
				<a class="btn btn-default btn-xs button avatar-webcam-capture" href="#"><?php esc_html_e( 'Capture', 'firmasite' );?></a>
				<a class="btn btn-default btn-xs button avatar-webcam-save" href="#"><?php esc_html_e( 'Save', 'firmasite' );?></a>
			</div>
		</div>
	<# } #>
</script>
