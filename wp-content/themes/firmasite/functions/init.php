...
function firmasite_enqueue_script() {
	...
	// if (visible_lg())
	add_action ("wp_footer", "firmasite_init_footer",901);
	function firmasite_init_footer() {
		global $firmasite_footer_junk_html; 
		?>
        <div id="firmasite_footer_junk">
        	...
        	<?php echo $firmasite_footer_junk_html;?>
...
// Database Updates
require_once ( get_template_directory() . '/functions/update-db/1_5_3.php');
