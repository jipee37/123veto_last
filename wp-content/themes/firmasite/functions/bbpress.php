...
function firmasite_social_bbp_get_forum_class ($classes) {
	$classes[] = "modal";
	$classes[] = "firmasite-modal-static";
	return $classes;
}

add_filter( 'bbp_get_reply_class', 'firmasite_bbp_get_reply_class', 10, 2 );
function firmasite_bbp_get_reply_class($classes, $reply_id) {
	$classes[] = "modal";
	$classes[] = "firmasite-modal-static";
	return $classes;
}
