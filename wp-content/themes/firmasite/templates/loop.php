...
switch($firmasite_settings["loop-style"]){
	case "loop-tile":
		...
		if (0 == $firmasite_loop_tile["item_left"]) {
			if(!(defined('DOING_AJAX') && DOING_AJAX)) {
				?>
				<li class="loop-grid-sizer loop_tile_<?php echo $firmasite_loop_tile_count; ?>_grid col-xs-12 col-sm-<?php echo round(12 / $firmasite_settings["loop_tile_row"]); ?> col-md-<?php echo round(12 / $firmasite_settings["loop_tile_row"]); ?>"></li>
				</ul>
				<?php
			}
