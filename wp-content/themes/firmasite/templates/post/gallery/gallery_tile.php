...
<ul id="<?php echo $selector; ?>" class="loop_tile list-unstyled row">
	...
	?>
    <li id="<?php echo $post->ID.'_image_'.$id; ?>" class="<?php echo "col-xs-12 col-sm-" . $howmuch_big . " col-md-" . $howmuch_big . " loop_tile_item loop_tile_" .$gallery_tile_id. "_item"; ?> fs-content-thumbnail">
...
<?php
		...
		if (0 == $gallery_tile_left) {
			if(!(defined('DOING_AJAX') && DOING_AJAX)) {
				?>
				<li class="loop-grid-sizer loop_tile_<?php echo $gallery_tile_id; ?>_grid col-xs-12 col-sm-<?php echo round(12 / $columns); ?> col-md-<?php echo round(12 / $columns); ?>"></li>
				</ul>
				<?php
			}
