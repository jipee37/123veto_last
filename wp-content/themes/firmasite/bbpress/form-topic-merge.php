...
<div id="bbpress-forums">
	...
	<?php if ( is_user_logged_in() && current_user_can( 'edit_topic', bbp_get_topic_id() ) ) : ?>
		...
		<div id="merge-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-merge panel panel-default">

			<form id="merge_topic" class="panel-body" name="merge_topic" method="post" action="<?php the_permalink(); ?>">
